...
//                console.log(3)
    ...
    for (a=0;a<level.length;a++){
        console.log({a,code:'<div><div style="font-size: 400%;">'+level[a].a+levenname[level[a].b]+'</div><div style="font-size:250%;">'+level[a].e+'</div></div>'})
        $('#output').html($('#output').html()+'<a><a style="font-size: 250%;">'+level[a].a+levenname[level[a].b]+'</a><a style="font-size:150%;">'+level[a].e+" "+'</a></a>')
    }   
}
/*
